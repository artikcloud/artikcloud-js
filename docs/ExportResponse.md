...
**endDate** | **Number** | Timestamp of latest message (in milliseconds since epoch). | [optional] 
...
**startDate** | **Number** | Timestamp of earliest message (in milliseconds since epoch). | [optional] 
