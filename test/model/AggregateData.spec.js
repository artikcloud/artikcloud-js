...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ArtikCloud.AggregateData();
  });
  ...
  describe('AggregateData', function() {
    it('should create an instance of AggregateData', function() {
      // uncomment below and update the code to test AggregateData
      //var instane = new ArtikCloud.AggregateData();
      //expect(instance).to.be.a(ArtikCloud.AggregateData);
    });
