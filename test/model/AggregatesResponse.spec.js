...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ArtikCloud.AggregatesResponse();
  });
  ...
  describe('AggregatesResponse', function() {
    it('should create an instance of AggregatesResponse', function() {
      // uncomment below and update the code to test AggregatesResponse
      //var instane = new ArtikCloud.AggregatesResponse();
      //expect(instance).to.be.a(ArtikCloud.AggregatesResponse);
    });
