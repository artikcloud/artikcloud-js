...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ArtikCloud.AggregatesHistogramData();
  });
  ...
  describe('AggregatesHistogramData', function() {
    it('should create an instance of AggregatesHistogramData', function() {
      // uncomment below and update the code to test AggregatesHistogramData
      //var instane = new ArtikCloud.AggregatesHistogramData();
      //expect(instance).to.be.a(ArtikCloud.AggregatesHistogramData);
    });
