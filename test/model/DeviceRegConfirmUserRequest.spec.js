...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ArtikCloud.DeviceRegConfirmUserRequest();
  });
  ...
  describe('DeviceRegConfirmUserRequest', function() {
    it('should create an instance of DeviceRegConfirmUserRequest', function() {
      // uncomment below and update the code to test DeviceRegConfirmUserRequest
      //var instane = new ArtikCloud.DeviceRegConfirmUserRequest();
      //expect(instance).to.be.a(ArtikCloud.DeviceRegConfirmUserRequest);
    });
