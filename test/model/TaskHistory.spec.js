...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ArtikCloud.TaskHistory();
  });
  ...
  describe('TaskHistory', function() {
    it('should create an instance of TaskHistory', function() {
      // uncomment below and update the code to test TaskHistory
      //var instane = new ArtikCloud.TaskHistory();
      //expect(instance).to.be.a(ArtikCloud.TaskHistory);
    });
