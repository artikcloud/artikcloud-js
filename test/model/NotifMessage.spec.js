...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ArtikCloud.NotifMessage();
  });
  ...
  describe('NotifMessage', function() {
    it('should create an instance of NotifMessage', function() {
      // uncomment below and update the code to test NotifMessage
      //var instane = new ArtikCloud.NotifMessage();
      //expect(instance).to.be.a(ArtikCloud.NotifMessage);
    });
