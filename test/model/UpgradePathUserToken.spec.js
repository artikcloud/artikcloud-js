...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ArtikCloud.UpgradePathUserToken();
  });
  ...
  describe('UpgradePathUserToken', function() {
    it('should create an instance of UpgradePathUserToken', function() {
      // uncomment below and update the code to test UpgradePathUserToken
      //var instane = new ArtikCloud.UpgradePathUserToken();
      //expect(instance).to.be.a(ArtikCloud.UpgradePathUserToken);
    });
