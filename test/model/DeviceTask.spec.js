...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ArtikCloud.DeviceTask();
  });
  ...
  describe('DeviceTask', function() {
    it('should create an instance of DeviceTask', function() {
      // uncomment below and update the code to test DeviceTask
      //var instane = new ArtikCloud.DeviceTask();
      //expect(instance).to.be.a(ArtikCloud.DeviceTask);
    });
