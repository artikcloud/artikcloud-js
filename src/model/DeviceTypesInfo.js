(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ArtikCloud.DeviceTypesInfo = factory(root.ArtikCloud.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>DeviceTypesInfo</code>.
   * 
   * @alias module:model/DeviceTypesInfo
   * @class
   */
  ...
  /**
   * Constructs a <code>DeviceTypesInfo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DeviceTypesInfo} obj Optional instance to populate.
   * @return {module:model/DeviceTypesInfo} The populated <code>DeviceTypesInfo</code> instance.
   */
