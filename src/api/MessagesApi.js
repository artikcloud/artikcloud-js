(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/AggregatesHistogramResponse', '../model/FieldPresenceEnvelope', '../model/NormalizedMessagesEnvelope', '../model/AggregatesResponse', '../model/SnapshotResponses', '../model/NormalizedActionsEnvelope', '../model/Actions', '../model/MessageIDEnvelope', '../model/Message'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AggregatesHistogramResponse'), require('../model/FieldPresenceEnvelope'), require('../model/NormalizedMessagesEnvelope'), require('../model/AggregatesResponse'), require('../model/SnapshotResponses'), require('../model/NormalizedActionsEnvelope'), require('../model/Actions'), require('../model/MessageIDEnvelope'), require('../model/Message'));
  } else {
    // Browser globals (root is window)
    if (!root.ArtikCloud) {
      root.ArtikCloud = {};
    }
    root.ArtikCloud.MessagesApi = factory(root.ArtikCloud.ApiClient, root.ArtikCloud.AggregatesHistogramResponse, root.ArtikCloud.FieldPresenceEnvelope, root.ArtikCloud.NormalizedMessagesEnvelope, root.ArtikCloud.AggregatesResponse, root.ArtikCloud.SnapshotResponses, root.ArtikCloud.NormalizedActionsEnvelope, root.ArtikCloud.Actions, root.ArtikCloud.MessageIDEnvelope, root.ArtikCloud.Message);
  }
}(this, function(ApiClient, AggregatesHistogramResponse, FieldPresenceEnvelope, NormalizedMessagesEnvelope, AggregatesResponse, SnapshotResponses, NormalizedActionsEnvelope, Actions, MessageIDEnvelope, Message) {
  'use strict';
